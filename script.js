document.getElementById("d2Submit").addEventListener("click", function(event) {
  ...
  document.getElementById("Results").style.backgroundImage = "url('https://www.bungie.net" + char1results.Response.character.data.emblemBackgroundPath +"')";
  let results2 = "";
  //title
  ...
  results2 += "<p> Last session length " + char1results.Response.character.data.minutesPlayedThisSession + " minutes<br>"
  results2 += "</p>"
  //aaaaand go ahead and print that baby out
